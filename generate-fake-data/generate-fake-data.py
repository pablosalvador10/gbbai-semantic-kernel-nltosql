...
# Insert Products
cursor.execute(
    "INSERT INTO products (product_id, product_name, product_description, product_price, product_category, in_stock) VALUES (?, ?, ?, ?, ?, ?)",
    1,
    "Apple iPhone 13",
...
# Insert Sellers
cursor.execute(
    "INSERT INTO sellers (seller_id, seller_name, seller_email, seller_contact_number, seller_address) VALUES (?, ?, ?, ?, ?)",
    1,
    "John Doe",
    "johndoe@example.com",
    "1234567890",
...
for i in range(100):
    ...
    cursor.execute(
        "INSERT INTO sales_transaction (transaction_id, product_id, seller_id, quantity, transaction_date) VALUES (?, ?, ?, ?, ?)",
        transaction_id,
        product_id,
        seller_id,
        quantity,
